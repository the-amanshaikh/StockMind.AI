          ...
          <form onSubmit={runBacktest} className="relative group col-span-1 md:col-span-full">
                  ...
                  <textarea
                    ...
                    onKeyDown={(e) => {
                      if (e.key === 'Enter' && !e.shiftKey) {
                        e.preventDefault();
                        if (strategy.trim() && strategyB.trim() && !loading) {
            ...
            <div className="grid gap-4 mt-8 grid-cols-1 md:grid-cols-3">
              <button
                type="button"
                onClick={() => {
                  setStrategy("Invest 100000 rupees in RELIANCE.NS on Jan 10 2022 and sell on Jan 10 2025");
                  setStrategyB("Invest 100000 rupees in TATAMOTORS.NS on Jan 10 2022 and sell on Jan 10 2025");
                }}
              ...
              >
                <div className="text-blue-400 font-black text-xs tracking-widest uppercase mb-3">Beginner Matchup</div>
              ...
              <button
                type="button"
                onClick={() => {
                  setStrategy("With 100000 rupees, buy ADANIENT.NS when it drops 5% and sell when it rises 10% starting from Jan 10 2022 upto Jan 30 2025");
                  setStrategyB("With 100000 rupees, buy RELIANCE.NS when it drops 5% and sell when it rises 10% starting from Jan 10 2022 upto Jan 30 2025");
                }}
              ...
              >
                <div className="text-emerald-400 font-black text-xs tracking-widest uppercase mb-3">Expert Matchup</div>
